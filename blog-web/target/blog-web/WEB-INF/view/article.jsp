...
<script src="${pageContext.request.contextPath}/static/js/index/article.js" type="text/javascript"></script>
                ...
                <div class="article-list" style="padding-top:10px;">
                    ...
                    <ul>
                        ...
                        <p>现在跨界联姻，时尚、汽车以及运动品牌联合手机制造商联合发布手机产品在行业里已经不再新鲜，上周我们给大家报道过著名手表制造商瑞士泰格·豪雅（Tag Heuer）
                            联合法国的手机制造商Modelabs发布的一款奢华手机的部分谍照，而近日该手机终于被正式发布了${pageContext.request.contextPath}.</p>
