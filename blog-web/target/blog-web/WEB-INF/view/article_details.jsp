...
<script src="${pageContext.request.contextPath}/static/js/index/article_details.js" type="text/javascript"></script>
...
<div class="layui-container container">
  ...
  <pre>public int update(String sql, Object[] params) throws DaoException {
		...
		return affectedRows;
          ...
          <p>
          	<img lay-src="${pageContext.request.contextPath}/static/images/4.jpg" layer-src="${pageContext.request.contextPath}/static/images/4.jpg" layer-pid layer-index="0" alt="Fly社区">
            <br/><br/>
            <img lay-src="${pageContext.request.contextPath}/static/images/5.jpg" layer-src="${pageContext.request.contextPath}/static/images/5.jpg" layer-pid layer-index="1" alt="Fly社区">
          </p>
        </div>
	...
	<div class="detail-box">
        ...
        <ul class="jieda" id="jieda">
          <li data-id="12" class="jieda-daan">
            ...
            <div class="detail-about detail-about-reply">
              <a class="jie-user" href="">
                <img src="${pageContext.request.contextPath}/static/images/default.png" alt="">
                <cite>
                  <i>纸飞机</i>
                  <!-- <em>(楼主)</em>
            ...
            <div class="detail-body jieda-body">
              <p>么么哒</p>
              <img lay-src="${pageContext.request.contextPath}/static/images/5.jpg" layer-src="${pageContext.request.contextPath}/static/images/5.jpg" alt="Fly社区">
            </div>
          ...
          <li data-id="13">
            ...
            <div class="detail-body jieda-body">
              <p>蓝瘦</p>
              <img lay-src="${pageContext.request.contextPath}/static/images/4.jpg" layer-src="${pageContext.request.contextPath}/static/images/4.jpg" layer-pid width="100px" height="80px" layer-index="3" alt="Fly社区">
            </div>
            <div class="jieda-reply">
    ...
    <div class="article-fenlei">
      ...
      <div class="ad"> <img src="${pageContext.request.contextPath}/static/images/ad.jpg"> </div>
      <div class="ms-top">
        <ul class="hd" id="tab">
      ...
      <div class="tuwen">
        <h3>图文推荐</h3>
        <ul>
          <li><a href="#"><img src="${pageContext.request.contextPath}/static/images/01.jpg"><b>住在手机里的朋友</b></a>
            <p><span class="tulanmu"><a href="#">手机配件</a></span><span class="tutime">2015-02-15</span></p>
          </li>
          <li><a href="#"><img src="${pageContext.request.contextPath}/static/images/02.jpg"><b>教你怎样用欠费手机拨打电话</b></a>
            <p><span class="tulanmu"><a href="#">手机配件</a></span><span class="tutime">2015-02-15</span></p>
          </li>
          <li><a href="#" title="手机的16个惊人小秘密，据说99.999%的人都不知"><img src="${pageContext.request.contextPath}/static/images/03.jpg"><b>手机的16个惊人小秘密，据说${pageContext.request.contextPath}.</b></a>
            <p><span class="tulanmu"><a href="#">手机配件</a></span><span class="tutime">2015-02-15</span></p>
          </li>
          <li><a href="#"><img src="${pageContext.request.contextPath}/static/images/06.jpg"><b>住在手机里的朋友</b></a>
            <p><span class="tulanmu"><a href="#">手机配件</a></span><span class="tutime">2015-02-15</span></p>
          </li>
          <li><a href="#"><img src="${pageContext.request.contextPath}/static/images/04.jpg"><b>教你怎样用欠费手机拨打电话</b></a>
            <p><span class="tulanmu"><a href="#">手机配件</a></span><span class="tutime">2015-02-15</span></p>
          </li>
        </ul>
      </div>
      <div class="ad"> <img src="${pageContext.request.contextPath}/static/images/03.jpg"> </div>
    </div>
  </div>
</div>
 <!-- footer -->
